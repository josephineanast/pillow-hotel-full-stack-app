  ...
  const handleDownload = () => {
    ...
    if (input) {
      html2canvas(input).then((canvas) => {
        ...
        pdf.addImage(img, 0, 0, pdfWidth, 0);
          ...
          <div id="booking_invoice" className="px-4 border border-secondary">
            <header className="clearfix">
              <div id="logo" className="my-4">
                <img src="/images/pillow_logo.png" />
              </div>
              ...
              <div id="company" className="clearfix">
                ...
                <div>
                  <a href="mailto:billing@pillow.com">billing@pillow.com</a>
                </div>
              </div>
              <div id="project">
                <div>
              ...
              <table className="mt-5">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="unit">September 1, 2023, 12:00:00 AM</td>
                    <td className="qty">September 5, 2023, 12:00:00 AM</td>
